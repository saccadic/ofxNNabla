...
NBLA_API vector<CgVariablePtr> softplus(Context &ctx, CgVariablePtr x);
NBLA_API CgVariablePtr softplus(CgVariablePtr x);
...
NBLA_API vector<CgVariablePtr> batch_normalization(Context &ctx, CgVariablePtr x, CgVariablePtr beta, CgVariablePtr gamma, CgVariablePtr mean, CgVariablePtr variance, const vector<int> & axes, float decay_rate, float eps, bool batch_stat);
NBLA_API CgVariablePtr batch_normalization(CgVariablePtr x, CgVariablePtr beta, CgVariablePtr gamma, CgVariablePtr mean, CgVariablePtr variance, const vector<int> & axes, float decay_rate, float eps, bool batch_stat);
...
NBLA_API vector<CgVariablePtr> bc_add2(Context &ctx, CgVariablePtr x0, CgVariablePtr x1);
NBLA_API CgVariablePtr bc_add2(CgVariablePtr x0, CgVariablePtr x1);

NBLA_API vector<CgVariablePtr> sub2(Context &ctx, CgVariablePtr x0, CgVariablePtr x1);
NBLA_API CgVariablePtr sub2(CgVariablePtr x0, CgVariablePtr x1);

NBLA_API vector<CgVariablePtr> mul2(Context &ctx, CgVariablePtr x0, CgVariablePtr x1);
NBLA_API CgVariablePtr mul2(CgVariablePtr x0, CgVariablePtr x1);

NBLA_API vector<CgVariablePtr> mul_n(Context &ctx, CgVariablePtr x);
NBLA_API CgVariablePtr mul_n(CgVariablePtr x);

NBLA_API vector<CgVariablePtr> div2(Context &ctx, CgVariablePtr x0, CgVariablePtr x1);
NBLA_API CgVariablePtr div2(CgVariablePtr x0, CgVariablePtr x1);

NBLA_API vector<CgVariablePtr> pow2(Context &ctx, CgVariablePtr x0, CgVariablePtr x1);
NBLA_API CgVariablePtr pow2(CgVariablePtr x0, CgVariablePtr x1);

NBLA_API vector<CgVariablePtr> add_scalar(Context &ctx, CgVariablePtr x, double val);
NBLA_API CgVariablePtr add_scalar(CgVariablePtr x, double val);

NBLA_API vector<CgVariablePtr> mul_scalar(Context &ctx, CgVariablePtr x, double val);
NBLA_API CgVariablePtr mul_scalar(CgVariablePtr x, double val);

NBLA_API vector<CgVariablePtr> pow_scalar(Context &ctx, CgVariablePtr x, double val);
NBLA_API CgVariablePtr pow_scalar(CgVariablePtr x, double val);
...
NBLA_API vector<CgVariablePtr> random_shift(Context &ctx, CgVariablePtr x, const vector<int> & shifts, const string & border_mode, int base_axis, int seed);
NBLA_API CgVariablePtr random_shift(CgVariablePtr x, const vector<int> & shifts, const string & border_mode, int base_axis, int seed);
